...
set name svm_speech_30_faddfsub_32ns_32ns_32_2_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fulldsp} LATENCY 1 ALLOW_PRAGMA 1
}


set name svm_speech_30_fadd_32ns_32ns_32_2_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fulldsp} LATENCY 1 ALLOW_PRAGMA 1
}


set name svm_speech_30_fmul_32ns_32ns_32_1_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fmul} IMPL {maxdsp} LATENCY 0 ALLOW_PRAGMA 1
}


set name svm_speech_30_fdiv_32ns_32ns_32_3_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fdiv} IMPL {fabric} LATENCY 2 ALLOW_PRAGMA 1
}


set name svm_speech_30_sitofp_32ns_32_2_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {sitofp} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}


set name svm_speech_30_fptrunc_64ns_32_1_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fptrunc} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name svm_speech_30_fcmp_32ns_32ns_1_1_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fcmp} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name svm_speech_30_sitodp_32ns_64_2_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler svm_speech_30_c_CompactClassificationECOC_pre_1_negloss_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { Mdl_BinaryLearners_address0 { O 9 vector } Mdl_BinaryLearners_ce0 { O 1 bit } Mdl_BinaryLearners_q0 { I 64 vector } Mdl_BinaryLearners_address1 { O 9 vector } Mdl_BinaryLearners_ce1 { O 1 bit } Mdl_BinaryLearners_q1 { I 64 vector } } \
} "
} else {
